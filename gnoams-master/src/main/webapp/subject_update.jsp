      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal" action="SubjectUpdateServlet" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7">
                    <input class="form-control" type="text" id="example-hf-day" placeholder="学科名称" name="subjectName" value="${subject.subjectName}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-hf-hire">成立日期</label>
                  <div class="col-md-7">
                    <input class="form-control" type="date" id="example-hf-hire" name="createTime" value="${subject.createTime}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-hf-qq">学科周期</label>
                  <div class="col-md-7">
                    <input class="form-control" type="text" id="example-hf-qq" placeholder="学科周期" name="subjectLife" value="${subject.subjectLife}">
                  </div>
                </div>
                <div class="form-group">
