            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="StudentAddServlet" method="post">
                                <input type="hidden" value="19800" name="tuition" />
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="gn_name">姓名</label>
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" id="gn_name" placeholder="学员姓名" name="studentName">
                                    </div>
                                </div>
                                <div class="form-group">
...
<%--                                            <option value="3">Python 1901</option>--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <label class="radio-inline" for="man">
                                            <input type="radio" checked="checked" id="man"  name="gender" value="1">
                                            男
                                        </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" id="idcard" placeholder="身份证" name="idCard">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="graduate_school">毕业学校</label>
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" id="graduate_school" placeholder="毕业学校" name="graduateSchool">
                                    </div>
                                </div>
                                <div class="form-group">
...
<%--                                            <option value="3">专科</option>--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="date" id="example-hf-hire" name="admissionTime">
                                    </div>
                                </div>
                                <div class="form-group">
