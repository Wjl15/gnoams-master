            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="RoleAddServlet" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <label class="radio-inline" for="example-inline-radio1">
                                            <input type="radio" checked id="example-inline-radio1" name="example-inline-radios" value="1">
                                            有效
                                        </label>
                                        <label class="radio-inline" for="example-inline-radio2">
                                            <input type="radio" id="example-inline-radio2" name="example-inline-radios" value="0">
                                            无效
                                        </label>
                                    </div>
                                </div>
