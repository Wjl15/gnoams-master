                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="EmployeeAddServlet" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" id="empName" placeholder="员工姓名" name="empName">
                                    </div>
                                </div>
                                <div class="form-group">
...
<%--                                            <option value="3">公关部</option>--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="email" id="email" placeholder="邮箱" name="email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="date" id="hire" name="hireTime">
                                    </div>
                                </div>
                                <div class="form-group">
